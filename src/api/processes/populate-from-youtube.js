...
const EVERY_FRIDAY_AT_435_PM = { hour: 16, minute: 35, dayOfWeek: 5 }
...
const populate = props => {
  ...
  return app => {
    ...
    scheduleJob(EVERY_FRIDAY_AT_435_PM, populateFromYoutube)
    app.log`populate-from-youtube scheduled every friday at 4:35pm`
